! function (t, e) {
    ...
    return function (t) {
        ...
        function k(t, e, n) {
            var o, r, i, a = y(t /= 255, e /= 255, n /= 255),
                c = g(t, e, n),
                s = c - a;
            if (i = c, 0 === s) o = r = 0;
            else {
        ...
        function S(t) {
            ...
            var n = e.options,
                o = e._tapstart;
            return a([n.wrapper, n.element], "mousedown", o), a([n.wrapper, n.element], "touchstart", o, {
                passive: !1
            }), e
        }
            ...
            return e = t, (n = [{
                ...
                value: function () {
                    var t = this,
                        e = this._root,
                        n = this.options,
                        o = [a(e.interaction.clear, "click", function () {
