...
function fromOffsetPath(ancestor, offsets) {
    ...
    for (var i = 0, len = offsets.length; i < len; i++) {
        //fixed by MIke 
        if (current.childNodes.length <= offsets[i] && current != undefined) {
...
//cambio no se puede subir imgs
            alert('Solo se puede imagenes de la galeria o links');
        ...
        this.context.memo('button.color', function () {
            return _this.ui.buttonGroup({
                ...
                children: [
                    ...
                    _this.button({
                        className: 'dropdown-toggle',
                        contents: _this.ui.dropdownButtonContents('<i class="fa fa-arrow-down"></i>', _this.options),
...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        popover: {
            image: [
                ['imagesize', ['imageSize100', 'imageSize50', 'imageSize25','imageSize75']],
                ['float', ['floatLeft', 'floatRight', 'floatNone']],
                ['remove', ['removeMedia']]
            ],
            link: [
