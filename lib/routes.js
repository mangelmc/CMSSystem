...
FlowRouter.route("/admin",{
	subscriptions : function(params,queryParams){
		//this.register("getSitios",Meteor.subscribe('getSitios'));
		this.register("getSitiosAdmin",Meteor.subscribe('getSitiosAdmin'));
		
		//console.log(params.titulo); tomar en cuenta nombres de sitios reservados root admin u otro
	},
	action : function(params,queryParams) {
...
FlowRouter.route("/admin/:titulo/banner",{
	subscriptions : function(params,queryParams){
		this.register("getBanner",Meteor.subscribe('getBanner',queryParams.id));
...
FlowRouter.route("/admin/:titulo/navbar",{
	subscriptions : function(params,queryParams){
		this.register("getMenu",Meteor.subscribe('getMenu',queryParams.id));
		this.register("getSitio",Meteor.subscribe('getSitio',params.titulo));
		this.register("getNavbar",Meteor.subscribe('getNavbar',queryParams.id));
		this.register("getSubmenu",Meteor.subscribe('getSubmenu',queryParams.id));
...
FlowRouter.route("/admin/:titulo/footer",{
	subscriptions : function(params,queryParams){
		this.register("getSitio",Meteor.subscribe('getSitio',params.titulo));
		this.register("getFooter",Meteor.subscribe('getFooter',queryParams.id));
