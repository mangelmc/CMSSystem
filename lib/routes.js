...
function checkRolAdmin() {
	Meteor.call('checkRolAdmin', 1, function (error, result) {
		if (result == false) {
			FlowRouter.go('/');
...
FlowRouter.route("/perfil", {
	subscriptions: function (params, queryParams) {
		...
		this.register("getAvatars", Meteor.subscribe('getAvatars'));
		//this.register("getImages", Meteor.subscribe("getImages", "ysMrYNGCnH38Tutva"));
	},
...
FlowRouter.route("/admin/:titulo/menucontenido", {
	...
	action: function (params, queryParams) {
		checkSitio(params.titulo);
		BlazeLayout.render("admin", {
			templateadmin: 'contentmenuadmin'
		});
	}
});
...
FlowRouter.route("/admin/:titulo/editcontenido/:idCont", {
	...
	action: function (params, queryParams) {
		checkSitio(params.titulo);
		BlazeLayout.render("admin", {
			templateadmin: 'editcontentadmin'
		});
	}
});
...
FlowRouter.route("/admin/:titulo/sidebar/editarmenuenlace", {
	...
	action: function (params, queryParams) {
		checkSitio(params.titulo);
		BlazeLayout.render("admin", {
			templateadmin: 'editarmenuenlace'
		});
	}
});
...
FlowRouter.route("/:titulo", {
	...
	subscriptions: function (params, queryParams) {
		...
		this.register("getHomeContentClient1", Meteor.subscribe('getHomeContentClient', params.titulo));
...
FlowRouter.route("/:titulo/searchcontent", {
	action: function (params, queryParams) {
		render.set(true);
		renderfoot.set(true);
...
FlowRouter.route("/:titulo/:menu/m/:contenido", {
	...
	subscriptions: function (params, queryParams) {
		...
		this.register("getComentsClient", Meteor.subscribe('getComentsClient', params.titulo, params.menu, params.contenido, 'menuonly'));
...
FlowRouter.route("/:titulo/:menu/:submenu/:contenido", {
	...
	subscriptions: function (params, queryParams) {
		...
		this.register("getMenuClient", Meteor.subscribe('getMenuClient', params.titulo));
		this.register("getCuerpoClient", Meteor.subscribe("getCuerpoClient", params.titulo));
		this.register("getSContentClient", Meteor.subscribe('getSContentClient', params.titulo, params.menu, params.submenu, params.contenido));
		this.register("getComentsClient", Meteor.subscribe('getComentsClient', params.titulo, params.submenu, params.contenido, params.menu));
